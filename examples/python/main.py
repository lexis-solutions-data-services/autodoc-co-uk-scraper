"""
Example: How to call the autodoc-co-uk-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/autodoc-co-uk-scraper
...
def run_actor():
    """Run the autodoc-co-uk-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/autodoc-co-uk-scraper"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": ["https://www.autodoc.co.uk/car-parts/engine-oil-12094/bmw/1er-reihe/1-convertible-e88/25443-118-i","https://www.autodoc.co.uk/mapco/2039778"],
            "maxItems": 10,
